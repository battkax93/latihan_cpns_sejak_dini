...
class _MyAppState extends State<MyApp> {
  ...
  void changePage(BuildContext ctx, String jenisSoal){
    Navigator.push(
        ctx,
        MaterialPageRoute(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        colorFilter: ColorFilter.mode(
                                            ...
                                            BlendMode.darken),
                                        image: NetworkImage(
                                            '$mainUrl/$mainHomeAsset/saintek-button-bg.jpg'),
                                        fit: BoxFit.cover)),
                                child: Center(
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        colorFilter: ColorFilter.mode(
                                            ...
                                            BlendMode.darken),
                                        image: NetworkImage(
                                            '$mainUrl/$mainHomeAsset/soshum-button-bg.jpg'),
                                        fit: BoxFit.cover)),
                                child: Center(
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
